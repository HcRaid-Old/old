...
public class TeamDeathmatch extends ArenaGame {
	Inventory teamInterfaceNormal, teamInterfacePremium;

	public TeamDeathmatch(Arena arena, Lobby lobby) {
		super(arena, lobby);
		setupInventories();
		setPrefix(ChatColor.GOLD + "[" + ChatColor.AQUA + "TDM"
